export type ProjectFileVersionRow = {
  id: string;
...
export type PublicProjectFileVersion = {
  id: string;
...
export const mapProjectFileVersionRow = (
  row: ProjectFileVersionRow
): PublicProjectFileVersion => ({
  id: row.id,
