...
export const RoxtecDetails = () => {
  ...
  useEffect(() => {
    ...
    setRoutings(getRoxtecRoutings(projectId, entry.rowId));
  }, [entry, projectId]);
  ...
  const saveRoutings = (nextRoutings: string[]) => {
    ...
    setRoxtecRoutings(projectId, entry.rowId, nextRoutings);
  };
