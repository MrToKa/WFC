import type { MaterialInstrumentInstallationMaterial } from '@/api/client';
...
export const MaterialInstrumentInstallationMaterialDetails = () => (
  <MasterMaterialDetailsPage<MaterialInstrumentInstallationMaterial>
